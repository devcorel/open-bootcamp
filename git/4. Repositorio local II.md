...
-  **HEAD se encuentra en la rama feature-demos**

-  Hacemos **git log --oneline**:
...
-  Hacemos **git checkout main** para posicionarnos en la rama principal.

-  **HEAD se encuentra en la rama main**

-  **git cherry-pick 108d852 4e23fed**:

   Hemos copiado los commits en concreto de la rama **feature-demos** a la rama **main**

-  Comprobamos con **git log --oneline**:
